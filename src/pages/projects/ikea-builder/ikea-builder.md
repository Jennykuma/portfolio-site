...
Jenny Le
###### Future Audience 
Young homeowners, people who get easily stressed/confused when it comes to building furniture or instructions.
###### Status 
...
using a mobile phone and Google Cardboard. Students can create their own 360 videos for this project; 
...
7. **Date Simulator** - For those who get anxious and nervous it comes to the first date. This will help the user go through a sequence of dialogue such that it will keep them thinking quick on their feet in tough situations. Enjoy some pretend pasta and fancy mood lighting as well! 
...
10. **360* Of A Dog's Life** - Wouldn't it be cool to experience what our furry friends see from their point of view? This simulator allows the user to see what they see and simulate what it's like to be a pet! 
...
1. **Converse With Others** - The whole simulator is based on socializing. Having a conversation with others will teach the user how to think quick on their feet and how to give polite answers rather than just being mean. 
...
8. **Choosing Music** - Music always makes the party more lively. Depending on the song you choose, you will receive different reactions which could make you more likable or the other way around. 
...
2. **Select via. Map** - The user will also have the option of selecting stores via a map instead of a list. This is easier for more visual people. 
...
4. **Find Washrooms and Playplaces** - On the map or list directory, the user will be able to toggle on and off options which allow them to see where the washrooms, food courts, and play places are. 
...
7. **Do A Quiz** - By doing a quiz, the user will be able to find stores that match the reason why they came to the mall in the first place. It could be a gift or shopping for clothes. After doing the quiz, the user will be recommended to some stores! 
...
10. **Play Music Based On Progress** - As the user starts, they will have to listen to confusing music, but as they get closer to their destination, the music will become happier! 
...
##### About
This simulator was the one that I managed to choose out of the remaining three choices. The reason why I decided to with this idea is that it relates to me a lot and I feel like many other people can relate as well. Furthermore, I brought a paper demo to the critique and I realized that I would like to pursue this idea. Additionally, I felt that it would be fun to build this, kind of like a parody of IKEA instructions as well.

Three things that I like about the simulator: 
###### 1. Music based on the situation
Animal Crossing music is a nice fit for the simulator! It adds a soothing calmness versus the Illuminati song that plays during the overwhelming instructions situation. It took me some time to find the right music, but it was worth it! 
###### 2. Instruction Layout
I like how the instructions are right in front of you as you build the furniture. You can also click on the images of the instructions to bring up a model of what it should look like after the step has been done. I think this is very helpful to see if you're on the right track or not. 
...
I enjoyed was recording the sounds and editing them on Audacity. I also enjoyed creating the parts on Blender. Seeing these small things being added to the project made a huge difference. Also editing the IKEA instruction sheets to help suit the simulator was extremely important because they need to be altered to help the user. 

I really wanted the user to enjoy building furniture and head into it thinking that it's not that bad. I included instructions in the beginning to let the user know what to use throughout the simulator to navigate. Also, I included the confusion scene because I wanted the user to experience confusion at first hand before heading into the building session. It could be more polished, but for the class presentation, I'm content to have something worthwhile to show.
